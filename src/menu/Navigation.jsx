...
const itemIds = [
  {
    ...
    title: "Home",
    link: "/",
    icon: <FaHome size={size} color="#fff" />,
  },
  {
    id: 1,
    title: "About",
    link: "/about",
    icon: <FaUser size={size} color="#fff" />,
  },
  {
    id: 2,
    title: "Contact",
    link: "/contact",
    icon: <MdPermContactCalendar size={size} color="#fff" />,
  },
  {
    id: 3,
    title: "Users",
    link: "/users",
    icon: <FaUsers size={size} color="#fff" />,
  },
  // {
  //     id: 4,
  //     title: "Blogs",
...
export const Navigation = ({ toggle }) => (
  <motion.ul className="ul" variants={variants}>
    {itemIds.map((icon) => (
      <MenuItem icon={icon} key={icon.id} toggle={toggle}/>
    ))}
  </motion.ul>
);
